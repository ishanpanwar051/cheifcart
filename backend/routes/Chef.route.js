 ...
 */
router.post('/create', verifyToken, isAdmin, createChef);
 ...
 */
router.put('/update/:id', verifyToken, isAdmin, updateChef);
 ...
 */
router.delete('/delete/:id', verifyToken, isAdmin, deleteCheftById);
 ...
 */
router.delete('/delete', verifyToken, isAdmin, DeleteAllChef);
