            ...
            <div className="p-4 lg:w-1/4 md:w-1/2 relative">
              <div className="h-full flex flex-col items-center text-center relative">
                <img
                  ...
                  src="/slider1.png"
                  onError={(e) => handleImageError(e, "https://via.placeholder.com/300x300?text=Register+on+App")}
                />
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2 relative">
              <div className="h-full flex flex-col items-center text-center relative">
                <img
                  ...
                  className="flex-shrink-0 rounded-lg w-full h-72 object-cover object-center mb-4"
                  src="/slider2.png"
                  onError={(e) => handleImageError(e, "https://via.placeholder.com/300x300?text=Select+Service")}
                />
                <FaArrowRight className="absolute top-1/2 left-72 transform -translate-y-1/2 text-orange-500 w-8 h-8" />
                <div className="w-full">
                  <h2 className="title-font font-medium text-lg text-gray-900">
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2 relative">
              <div className="h-full flex flex-col items-center text-center relative">
                <img
                  ...
                  className="flex-shrink-0 rounded-lg w-full h-72 object-cover object-center mb-4"
                  src="/slider3.png"
                  onError={(e) => handleImageError(e, "https://via.placeholder.com/300x300?text=Make+Payment")}
                />
            ...
            <div className="p-4 lg:w-1/4 md:w-1/2 relative">
              <div className="h-full flex flex-col items-center text-center relative">
                <img
                  ...
                  className="flex-shrink-0 rounded-lg w-full h-72 object-cover object-center mb-4"
                  src="/slider4.png"
                  onError={(e) => handleImageError(e, "https://via.placeholder.com/300x300?text=Get+a+Cook")}
                />
