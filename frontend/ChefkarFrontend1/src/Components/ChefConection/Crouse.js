...
const Carousel = () => {
  ...
  useEffect(() => {
    const fetchSlides = async () => {
      try {
        const res = await axios.get("http://localhost:3000/crousel/get");
        ...
        setSlides([
          {
            ...
            description: "Become part of India's largest at-home cooking network",
            bgImage: "/slider1.png",
            action: "Register Now"
          },
          {
            title: "Earn with Your Skills",
            description: "Monetize your cooking expertise with flexible working hours",
            bgImage: "/slider2.png", 
            action: "Start Earning"
          },
          {
            title: "Serve Happy Families",
            description: "Bring delicious meals to thousands of households across India",
            bgImage: "/slider3.png",
            action: "Join Us"
          }
        ]);
      ...
      >
        {slides.map((slide, index) => (
          <div
            ...
            onError={(e) => {
              e.target.style.backgroundImage = 'url(https://via.placeholder.com/1920x1080?text=ChefKart+Join+Us)';
            }}
          >
